...
export default function Header() {
  ...
  const { setShowSettings, serverProps, config } = useAppContext();
  ...
  return (
    <div className="flex flex-row items-center pt-6 pb-6 sticky top-0 z-10 bg-base-100">
      ...
      <div className="grow ml-2">
        <div className="text-2xl font-bold">BPF OpEx Chat - INTERNAL USE ONLY - DO NOT USE FOR PRODUCTON</div>
        <div className="text-xs opacity-70 mt-1">
          Server: <code>{config.apiBase}</code>
          <span className={classNames({ 'badge badge-xs ml-2': true, 'badge-success': connected, 'badge-warning': !connected })}>
